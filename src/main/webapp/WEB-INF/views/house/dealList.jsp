					...
					function() {
						...
						$("#groupall")
								.click(
										function() {
											if ($("#dong").val() != "0")
												location.href = "${root}/house/main?group=all&contents="
														+ $("#contents").val()
														+ "&pg="
														+ $("#pg").val()
														+ "&dong="
						...
						$("#groupapt")
								.click(
										function() {
											if ($("#dong").val() != "0")
												location.href = "${root}/house/main?group=apt&contents="
														+ $("#contents").val()
														+ "&pg="
														+ $("#pg").val()
														+ "&dong="
						...
						$("#grouphouse")
								.click(
										function() {
											if ($("#dong").val() != "0")
												location.href = "${root}/house/main?group=house&contents="
														+ $("#contents").val()
														+ "&pg="
														+ $("#pg").val()
														+ "&dong="
																		...
																		.each(
																				...
																				function(
																					...
																					let str = "<div class='justify-content-center border-bottom' align='left' style='margin-top:20px'>"
																							+ "<a href='${root}/house.do?act=house_info&no="
																							+ vo.no
				...
				<div class="form-group input-group col-6">
					...
					<div class="input-group-append">
						<button type="button" class="btn btn-primary"
							onclick="javascript:requestFilteredHouses();">검색</button>
					</div>
				</div>
