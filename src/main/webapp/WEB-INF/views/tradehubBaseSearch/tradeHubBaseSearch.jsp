...
<body>
	<div class="container">
		...
		<div class="col-lg-12" style="margin-top : 100px">
			...
			<div align="center">
				<h2>거래 목록</h2>
				<button onclick="javascript:tradeHubAccess()"> 상권 정보 확인용 </button>
			...
			<div id="searchResult">
				<%-- 상권 정보 갯수 확인 
				<c:if test="${totalHub ne null}">
					<p style = "color: red; font-size : 22px; margin-bottom : 0px">totalHub : ${totalHub }</p>
				</c:if> --%>
